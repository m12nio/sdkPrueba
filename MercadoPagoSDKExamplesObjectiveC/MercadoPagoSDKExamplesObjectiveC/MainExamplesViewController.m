...
-(void)setPaymentResultScreenPreference {
    ...
    [resultPreference setApprovedSubtitleWithSubtitle:@"Subtitulo"];
...
-(void)setReviewScreenPreference {
    ...
    [reviewPreference setCustomItemCellWithCustomCell:[NSArray arrayWithObjects:customCargaSube2, customCargaSube, nil]];
